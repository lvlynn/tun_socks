...
$(PWD)/objs/src/core/nt_core.o:  $(CORE_DEPS) \
	$(PWD)/src/core/nt_core.c 
	$(CC) -c $(CFLAGS) $(NT_INCLUDE) \
		-o $(PWD)/objs/src/core/nt_core.o \
		$(PWD)/src/core/nt_core.c
...
$(PWD)/objs/src/core/nt_slab.o:  $(CORE_DEPS) \
	$(PWD)/src/core/nt_slab.c
	$(CC) -c $(CFLAGS) $(NT_INCLUDE) \
		-o $(PWD)/objs/src/core/nt_slab.o \
		$(PWD)/src/core/nt_slab.c

$(PWD)/objs/src/core/nt_shmtx.o:  $(CORE_DEPS) \
	$(PWD)/src/core/nt_shmtx.c
	$(CC) -c $(CFLAGS) $(NT_INCLUDE) \
		-o $(PWD)/objs/src/core/nt_shmtx.o \
		$(PWD)/src/core/nt_shmtx.c

$(PWD)/objs/src/core/nt_cpuinfo.o:  $(CORE_DEPS) \
	$(PWD)/src/core/nt_cpuinfo.c
	$(CC) -c $(CFLAGS) $(NT_INCLUDE) \
		-o $(PWD)/objs/src/core/nt_cpuinfo.o \
		$(PWD)/src/core/nt_cpuinfo.c

$(PWD)/objs/src/core/nt_open_file_cache.o:  $(CORE_DEPS) \
	$(PWD)/src/core/nt_open_file_cache.c
	$(CC) -c $(CFLAGS) $(NT_INCLUDE) \
		-o $(PWD)/objs/src/core/nt_open_file_cache.o \
		$(PWD)/src/core/nt_open_file_cache.c
